    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        {(Object.keys(counts) as Array<keyof typeof counts>).map((status) => (
          <div
            key={status}
            className="rounded-lg border bg-card/50 p-4 sm:p-5 flex flex-col items-center justify-center capitalize shadow-sm hover:shadow-md hover:bg-card transition-all"
